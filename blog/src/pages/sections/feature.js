import DepthImage from '../../assets/images/dddepth-345.jpg'
/*************  ✨ Codeium Command 🌟  *************/
function App() {
  // let styles = {
  ...
  return (
    <div className="padding-sides feature-wrapper">
...
/******  c44c1097-bc7e-4eac-9cf4-adc8c4aaa1f3  *******/

export default App;

{
  /* <div className="features-container  padding-sides" style={{position: 'relative'}}>
